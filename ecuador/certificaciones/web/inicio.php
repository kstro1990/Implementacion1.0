      ...
      <div class="content">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header ">
                <h5 class="card-category">Total devueltos</h5>
                <h3 class="card-title"><i class="tim-icons icon-bell-55 text-primary "></i> Por Mes</h3>
              </div>
              <div class="card-body ">
                <div class="chart-area">
          ...
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header ">
                <h5 class="card-category">Total en Certificación</h5>
          ...
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header ">
                <h5 class="card-category">Por Mes</h5>
                <h3 class="card-title"><i class="tim-icons icon-send text-success "></i> Total SAP</h3>
              </div>
              <div class="card-body ">
                <div class="chart-area">
