        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-body">
                <form action="../class/usuarioAdd.php" method="post">
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        <label>Empresa</label>
                        <input type="text" class="form-control"  placeholder="PlacetoPay" name="empresa">
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" placeholder="luis.castro@placetopay.com" name="email">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                      <div class="col-md-4 pr-md-1">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="luis.castro@placetopay.com" name="extension">
                          </div>
                        </div>
                        <div class="col-md-4 px-md-1">
                          <div class="form-group">
                            <label for="exampleInputEmail1">Roll</label>
                            <select class="form-control" name="id_roll">
